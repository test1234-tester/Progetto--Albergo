...
public class PrenotazioneSpa {
	...
	public PrenotazioneSpa(Long idPrenotazioneSpa, Long idUtente, Long idPagamento, LocalDate data, boolean stato, LocalTime orario_inizio, LocalTime orario_fine) {
