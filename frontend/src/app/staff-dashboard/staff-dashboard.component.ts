 ...
 * ---------------------------------------------------------------------------
 * Gestionale staff: statistiche, prenotazioni, camere e prenotazioni in struttura.
...
export class StaffDashboardComponent implements OnInit {
  ...
  /** BLOCCO DIDATTICO — Carica i dati iniziali del gestionale staff. */
  ngOnInit(): void {
    this.resetPhysicalBookingForm();
    this.loadDashboard();
  }

  /** BLOCCO DIDATTICO — Utility condivisa dai form del gestionale per gli stati di errore. */
  isInvalid(control: AbstractControl | null): boolean {
    return !!control && control.invalid && (control.touched || control.dirty);
  }

  /** BLOCCO DIDATTICO — Recupera statistiche, prenotazioni, camere e clienti dal backend. */
  loadDashboard(): void {
  ...
  /** BLOCCO DIDATTICO — Cambia la sezione attiva del pannello staff. */
  ...
  /** BLOCCO DIDATTICO — Mostra o nasconde il form per prenotazioni registrate in reception. */
  togglePhysicalBookingForm(): void {
    this.showPhysicalBookingForm.update((value) => !value);
    this.clearMessages();
  }

  /** BLOCCO DIDATTICO — Valida e salva nel DB una prenotazione creata dallo staff. */
  ...
  /** BLOCCO DIDATTICO — Copia i dati della prenotazione nel form di modifica. */
  ...
  /** BLOCCO DIDATTICO — Esce dalla modalità modifica senza inviare cambiamenti. */
  ...
  /** BLOCCO DIDATTICO — Valida e persiste le modifiche staff alla prenotazione. */
  ...
  /** BLOCCO DIDATTICO — Cancella definitivamente una prenotazione attraverso il backend. */
  ...
  /** BLOCCO DIDATTICO — Aggiorna lo stato operativo della camera selezionata. */
  ...
  /** BLOCCO DIDATTICO — Traduce il codice tecnico dell’origine in una label leggibile. */
